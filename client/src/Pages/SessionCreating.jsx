...
const ListingCreation = () => {
  ...
  useEffect(() => {
    const f = async () => {
      if (pinCode.length === 6) {
        const res = await userRequest.post("/listing/usePincode", {
          pinCode: pinCode,
        });
  ...
  async function postImage({ image }) {
    ...
    const result = await userRequest.post("/listing/sendImage", formData, {
  ...
  const handleClick = async (e) => {
    ...
    if (res.status === 200) {
      await setRetMessage(
        "The Listing is created Successfully. Thank You for Listing with Us."
      );
      await setOpn(true);
    }
  };
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={12}>
                  ...
                  <TextField
                    ...
                    id="outlined-basic"
                    label="Rate"
                    placeholder=" Charges in ₹ without any (,) or spaces"
                    fullWidth
                ...
                <Grid item xs={12} md={12}>
                  ...
                  <TextField
                    ...
                    id="outlined-basic"
                    label="Area"
                    placeholder="Area of plot/house in sq ft. in number"
                    fullWidth
                    sx={{ backgroundColor: "white" }}
                    autoComplete="off"
