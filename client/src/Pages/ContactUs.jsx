            ...
            <Grid container spacing={2}>
                <Grid item xs={12} md={12}>
                        <Typography
                            variant="h5"
                            component="div"
                            sx={{ mr: 2,  padding:'2% 5%', textAlign:'center', color:'#Black' }}
                            >
                                Contact Us
                        </Typography>
                        <Typography
                            variant="p"
                            component="div"
                            sx={{ mr: 2,  padding:'1% 30%', textAlign:'center', color:'text.secondary' }}
                            >
                        ...
                        <Grid container spacing={0} sx={{margin:'5% 20%', alignItems:'center', position:'relative', left:'5%'}}>
                            <Grid item xs={12} md={4} sx={{marginBottom: 5}}>
                                <Card variant='elevation' elevation={4} sx={{ width:200, height:250, padding:'2%', alignSelf:'center' }}>
                                    ...
                                    <CardContent>
                                        ...
                                        <CallIcon sx={{position:'relative', top:'5px'}} /> +91 000 000 0000
                                        </Typography>
                                    </CardContent>
                                </Card>
                            </Grid>
                            ...
                            <Grid item xs={12} md={4} sx={{marginBottom: 5}}>
                                 <Card variant='elevation' elevation={4} sx={{ width:200, height:250 ,padding:'2%', alignSelf:'center' }}>
                                        ...
                                        <CardContent>
                                        <Typography gutterBottom variant="body2" component="div">
                                        <PersonIcon sx={{position:'relative', top:'5px'}} /><a className='navMenurev' href="mailto:">sample@mail.com</a>
                                            <br />
                                        </Typography>
                                        
                                        <Typography variant="body2" color="text.secondary" sx={{ fontSize: 14 }}>
                                            <MailOutlineIcon sx={{position:'relative', top:'5px'}} /> <a className='navMenurev' href="mailto:">ample@b.com</a>
                                        </Typography>
                                    </CardContent>
                                </Card>
                            </Grid>
                            ...
                            <Card variant='elevation' elevation={4} sx={{ width:200, height:250, padding:'2%', alignSelf:'center'}}>
                                        ...
                                        <Typography variant="body2" color="text.secondary" sx={{ fontSize: 14 }}>
                                            <a href="" className='navMenu'><Button sx={{backgroundColor:'#FFB923', color:'black'}}><WhatsAppIcon />Join Now </Button></a>
                                        </Typography>
                                    </CardContent>
                                </Card>
                            </Grid>
